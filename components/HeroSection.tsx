	...
	return (
		<div className="mt-39 flex flex-col items-center px-0 md:px-4 pb-72">
			<div className=" relative">
				...
				<div className="flex flex-col items-center gap-6 px-0 md:px-16 mx-auto z-20">
					<span className="font-medium text-[#0B76FA] text-xl py-1 px-2 bg-[#0B76FA1A] rounded-[100]">
						Вместе сильнее!
					</span>
					...
					<div className="text-center mx-auto max-w-[500px] md:max-w-[1000px]">
						...
						<p className="text-[#5F6368] text-base md:text-xl mt-6 leading-relaxed mx-auto max-w-[680px] text-center">
							Мы объединяем{" "}
							<span className="font-bold italic">амбициозных</span> и{" "}
							<span className="font-bold italic">молодых</span> специалистов,
							чтобы запускать{" "}
							<span className="font-bold italic">сильные команды</span> и
							воплощать <span className="font-bold italic">смелые идеи</span> в
							жизнь.
						</p>
					</div>
