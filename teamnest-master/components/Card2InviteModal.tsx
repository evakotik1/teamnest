...
import Notion from '@/public/imageNotion.svg'
        ...
        <>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl max-w-[620px] w-full max-h-[90vh] overflow-y-auto"
                    ...
                    <div className="flex flex-col items-start p-10 md:p-4 gap-4">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 w-full">
                            <div className="flex flex-col justify-center items-start bg-[#F8F9FB] border border-[#1C1C1C]/5 rounded-2xl overflow-hidden">
                                <Image src={Notion} alt="img" className="rounded-t-2xl w-full"/>
                    ...
                    <div className="flex justify-end items-center gap-4 px-10 md:px-4 pb-4">
                        <button 
                            onClick={onBack}
                            className="font-medium px-6 py-2.5 border border-[#1C1C1C] rounded-2xl hover:bg-gray-50 transition-colors">
                            Назад
                        </button>
