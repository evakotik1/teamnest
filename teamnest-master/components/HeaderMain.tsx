...
import Anton from '@/public/Anton.svg';
import CircleUserAround from '@/public/circle-user-round.svg'
import FolderOpen from '@/public/folder-open.svg'
import NotebookTabs from '@/public/notebook-tabs.svg'
import Star from '@/public/star.svg'
import LogOut from '@/public/log-out.svg'
import { useState, useEffect, useRef} from 'react';
import { Menu } from 'lucide-react';
import { BackgroundCubes } from "@/app/icons/backgroundCubes";
...
export default function HeaderMain() {
    ...
    return ( 
        <header className="relative">
            ...
            <div className="flex justify-center pt-4 px-0 md:px-16">
                
                <div className="max-w-7xl flex items-center justify-between gap-12 p-3 mx-auto bg-[#1C1C1C] min-h-[69px] rounded-2xl shadow-[0px_51px_31px_rgba(0,0,0,0.01),0px_23px_23px_rgba(0,0,0,0.02),0px_6px_13px_rgba(0,0,0,0.02)] w-full md:w-auto"> 
                        ...
                        {!isLoggedIn ? (
                            ...
                            <>
                                <button
                                    ...
                                    <Image src={Anton} alt="Avatar" className="h-8 w-8"/>
                                    <Menu size={24} />
                                </button>
                                {isDropdownOpen && (
                                            ...
                                            <div className="flex flex-col items-start gap-2">
                                                <div className="flex flex-col items-start">
                                                    <div className="flex items-center py-2 gap-2 rounded-lg">
                                                        <Image src={CircleUserAround} alt="user" />
                                                        <span className=" text-[#1C1C1C]">Мой профиль</span>
                                                    </div>
                                                    <div className="flex items-center py-2 gap-2 rounded-lg">
                                                        <Image src={FolderOpen} alt="projects" />
                                                        <span className=" text-[#1C1C1C]">Мои проекты</span>
                                                    </div>
                                                    <div className="flex items-center py-2 gap-2 rounded-lg">
                                                        <Image src={NotebookTabs} alt="responses"/>
                                                        <span className=" text-[#1C1C1C]">Мои отклики</span>
                                                    </div>
                                                    <div className="flex items-center py-2 gap-2 rounded-lg">
                                                        <Image src={Star} alt="favorites"/>
                                    ...
                                    <div className="mt-auto">
                                        <div className="w-full gap-6 flex flex-col items-start">
                                            ...
                                            <div className="flex justify-center items-center gap-4">
                                                <Image src={Anton} alt="Avatar" className="h-12 w-12 rounded-full"/>
                                                <div className="flex flex-col justify-center items-start">
                                            ...
                                            <div className="flex flex-col items-start w-full">
                                                <div className="flex items-center py-2 gap-4 rounded-lg w-full">
                                                    <Image src={CircleUserAround} alt="user" className="h-6 w-6"/>
                                                    <span className=" text-[#1C1C1C] text-xl">Мой профиль</span>
                                                </div>
                                                <div className="flex items-center py-2 gap-4 rounded-lg w-full">
                                                <Image src={FolderOpen} alt="projects" className="h-6 w-6"/>
                                                    <span className=" text-[#1C1C1C] text-xl">Мои проекты</span>
                                                </div>
                                                <div className="flex items-center py-2 gap-4 rounded-lg w-full">
                                                    <Image src={NotebookTabs} alt="responses" className="h-6 w-6"/>
                                                    <span className=" text-[#1C1C1C] text-xl">Мои отклики</span>
                                                </div>
                                                <div className="flex items-center py-2 gap-4 rounded-lg w-full">
                                                    <Image src={Star} alt="favorites" className="h-6 w-6"/>
                                            ...
                                            <div className="flex items-center py-2 gap-4 rounded-lg w-full cursor-pointer" onClick={handleLogout}>
                                                <Image src={LogOut} alt="logout" className="h-6 w-6" />
